...
article.children[0].style.background = "url(./photo/paysage_1.jpg) 50% 50% no-repeat";
article.children[1].style.background = "url(./photo/paysage_2.jpg) 50% 50% no-repeat";
...
article.onclick = function(){
    ...
    for(let modifImg of this.children){
        modifImg.classList.toggle("lachePas");
    }
}